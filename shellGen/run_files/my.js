...
inputData= {
	"create_project":"mkdir -p " +  getValue('create_project_path') + "/" +  getValue('create_project_name') +
	 ...
	 getValue('create_project_name')+".commands.txt,"+getValue('create_project_name')+".log.txt}"
,
...
,"convert_fastaqual_fastq":"convert_fastaqual_fastq.py -f " +  getValue('convert_fastaqual_fastq-f') + " -q " +  getValue('convert_fastaqual_fastq-q') + " -o " +  getValue('convert_fastaqual_fastq-o') + " "
,"extract_barcodes":"extract_barcodes.py -f " +  getValue('extract_barcodes-f') + " -c " +  getValue('extract_barcodes-c') + " --bc1_len " +  getValue('extract_barcodes--bc1_len') + " -o " +  getValue('extract_barcodes-o') + " "
...
,"filter_fasta":"filter_fasta.py -f " +  getValue('filter_fasta-f')+"  -s " +  getValue('filter_fasta-s') + " -o " +  getValue('filter_fasta-o') + " -n "
,"pick_open_reference_otus":"pick_open_reference_otus.py -f -i " +  getValue('pick_open_reference_otus-i') + " -r " +  getValue('pick_open_reference_otus-r') + " -o " +  getValue('pick_open_reference_otus-o') + " -aO 8 "
,"pick_closed_reference_otus":"pick_closed_reference_otus.py -f -i " +  getValue('pick_closed_reference_otus-i') + " -t " +  getValue('pick_closed_reference_otus-t') + " -r " +  getValue('pick_closed_reference_otus-r') + " -o " +  getValue('pick_closed_reference_otus-o') + " -aO 8 "
...
,"alpha_rarefaction":"alpha_rarefaction.py -i " +  getValue('alpha_rarefaction-i') + " -o " +  getValue('alpha_rarefaction-o') + " -m " +  getValue('alpha_rarefaction-m') + " -p " +  getValue('alpha_rarefaction-p') + " -t " +  getValue('alpha_rarefaction-t') + " -f -aO 8"
...
,"beta_diversity_through_plots":"beta_diversity_through_plots.py -i " +  getValue('beta_diversity_through_plots-i') + " -o " +  getValue('beta_diversity_through_plots-o') + " -m " +  getValue('beta_diversity_through_plots-m') + " -t " +  getValue('beta_diversity_through_plots-t') + "  -f -aO 8 "
,"make_2d_plots":"make_2d_plots.py -i " +  getValue('make_2d_plots-i') + " -m " +  getValue('make_2d_plots-m') + " -o " +  getValue('make_2d_plots-o') + " "
,"summarize_taxa_through_plots":"summarize_taxa.py -i " +  getValue('summarize_taxa_through_plots-i') + " -m " +  getValue('summarize_taxa_through_plots-m') + " -o " +  getValue('summarize_taxa_through_plots-o') + "  -L 2,3,4,5,6,7 \n "+"summarize_taxa_through_plots.py -i " +  getValue('summarize_taxa_through_plots-i') + " -m " +  getValue('summarize_taxa_through_plots-m') + " -o " +  getValue('summarize_taxa_through_plots-o') + " -f "
